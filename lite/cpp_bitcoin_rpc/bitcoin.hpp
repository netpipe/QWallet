...
namespace bitcoin {
    ...
    class client
    {
        public:
            ...
            std::string createrawtransaction( const std::string& transaction_input, const std::string& address_amount );
            bool signrawtransaction( const std::string& transaction_input );
            std::string sendrawtransaction( const std::string& transaction_input );
